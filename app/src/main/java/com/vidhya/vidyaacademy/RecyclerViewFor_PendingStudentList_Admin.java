...
public class RecyclerViewFor_PendingStudentList_Admin extends RecyclerView.Adapter<RecyclerViewFor_PendingStudentList_Admin.ViewHolder> {
    ...
    public RecyclerViewFor_PendingStudentList_Admin(Context context, ArrayList<Pending_Studlist_Adapter> arrayList, String ClassID, String AdminID) {
        this.list = arrayList;
    ...
    @NonNull
    @Override
    public RecyclerViewFor_PendingStudentList_Admin.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        CardView view = (CardView) LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_pending_studentlist_card_admin, viewGroup, false);
        return new RecyclerViewFor_PendingStudentList_Admin.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerViewFor_PendingStudentList_Admin.ViewHolder viewHolder, final int i) {
        final int j;
