...
public class F_Princi_Approved_Studentlist extends Fragment {
       ...
       /* Intent i = getIntent();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                RecyclerViewFor_ApprovedStudentList_Princi playAdapter1 = new RecyclerViewFor_ApprovedStudentList_Princi(getActivity(),arrayList,ClassID,AdminID);
